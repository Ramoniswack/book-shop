          ...
          <div className="flex bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden dark-transition">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-booksmandala-blue to-blue-800">
              ...
              <div className="relative z-10 flex flex-col justify-center items-center text-white p-8 text-center">
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold mb-3">Welcome to BooksMandala</h3>
                  <p className="text-lg text-blue-100 leading-relaxed">
                    Discover your next favorite book from our vast collection of over 35,000 titles.
                  </p>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center p-6 sm:p-8 lg:p-10">
              <div className="w-full max-w-sm mx-auto">
                ...
                {/* Google Sign In */}
                <button className="w-full flex items-center justify-center py-2.5 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-booksmandala-blue transition-all duration-200 mb-4 dark-transition">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="block w-full pl-9 pr-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-booksmandala-blue focus:border-booksmandala-blue transition-all duration-200 bg-gray-50 dark:bg-gray-700 focus:bg-white dark:focus:bg-gray-600 text-sm dark-transition"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <Link 
                        ...
                        className="text-xs text-booksmandala-blue hover:text-blue-700 font-medium transition-colors"
                      >
                        Forgot password?
                      </Link>
                    </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="h-4 w-4 text-booksmandala-blue focus:ring-booksmandala-blue border-gray-300 rounded"
                    />
